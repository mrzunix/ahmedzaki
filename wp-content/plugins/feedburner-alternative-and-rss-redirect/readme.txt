...
Free Feedburner Alternative and RSS Redirect plugin from SpecificFeeds.com. 

== Description ==
This plugin allows you to easily switch from Feedburner to the FREE (and better) Feedburner alternative S-Feeds.com.  

Read all about the service on http://www.specificfeeds.com/rss.
...
- Step 3: Connect it to a SpecificFeeds.com account to get access to your subscribers, see statistics etc. (see screenshots) 
...
= 1.4 =
* Occasionally it took the Feedburner feed as underlying feed, this is fixed now

= 1.3 =
* Fast clicking on several redirect icons caused several feeds to get set up, this is fixed now
...
= 1.5 =
* No need to upgrade if you didn't face any issues